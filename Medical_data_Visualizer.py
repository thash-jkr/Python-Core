...
# Draw Categorical Plot Create DataFrame for cat plot using `pd.melt` using just the values from 'cholesterol',
...
sns.heatmap(corr, mask=mask, lw=1, annot=True, fmt='0.1f', square=True, center=0.08, cbar_kws={"shrink": 0.5})
